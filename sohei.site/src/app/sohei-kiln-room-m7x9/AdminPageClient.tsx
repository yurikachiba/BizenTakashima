...
export default function AdminPageClient() {
        ...
        <div className="auth-box">
          ...
          <form id="auth-form" onSubmit={handleLogin}>
            <div className="auth-input-wrapper">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="auth-input-icon">
                    ...
                    {Object.entries(stats.daily)
                      ...
                      .map(([date, data]) => {
                        const maxVal = Math.max(
                          ...Object.values(stats.daily).map((d) => d.total || 0),
                          1,
                        );
                        return (
  ...
  const renderEditor = (page: string) => {
    ...
    const hasChanges = keys.some(
      (key) => (pageContent[key] || '') !== (content[page]?.[key] || ''),
    );
                ...
                return (
                  <div key={key} className="image-card">
                    <div className="image-card__preview">
                      ...
                      {uploadedImages[key] && (
                        <span className="image-card__badge">カスタム</span>
                      )}
                    </div>
