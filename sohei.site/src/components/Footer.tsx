...
export default function Footer() {
  ...
  return (
    <footer>
      <h2 className="marginB10px marginT120px" data-content-key="index.heading_contact">
        {getContent('index.heading_contact', 'お問い合わせ')}
      </h2>
      <p className="text-5" data-content-key="index.contact_text">
      ...
      <div className="footer">
        <div>
          <a href="#" id="back-to-top">
            <Image src="/img/top.png" alt="トップへ戻る" width={40} height={40} />
          </a>
        </div>
        <div>
      ...
      <div style={{ padding: '16px' }}>
        ...
        >
          <a
            ...
            target="_blank"
          >
            高島聡平 Takashima Sohei(@takashima_sohei)がシェアした投稿
          </a>
        </p>
      </div>
    </blockquote>
